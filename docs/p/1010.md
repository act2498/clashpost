...
2024-04-16 修订：重新组织文章结构，将胜利之星奖励拆分到另一篇文章。<br>
2022-11-19 修订：之前大师杯和冠军杯的宝石奖励写错了，这次修订进行纠正。
</PostHistory>
...
<Table maxWidth="750px">
    <table>
        ...
        <tr>
            ...
            <td class="cp-table-col-numeric">320</td>
        </tr>
        <tr>
            <td>大师三</td>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-numeric">740</td>
        </tr>
        <tr>
            <td>大师一</td>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-numeric">920</td>
        </tr>
        <tr>
            <td>冠军三</td>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-numeric">1 220</td>
        </tr>
        <tr>
            <td>冠军二</td>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-numeric">1 580</td>
        </tr>
        <tr>
            <td>泰坦三</td>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-numeric">1 880</td>
        </tr>
        <tr>
            <td>泰坦二</td>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-numeric">2 060</td>
        </tr>
        <tr>
            <td>泰坦一</td>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-numeric">2 240</td>
        </tr>
        <tr>
            <td>传奇</td>
            <td class="cp-table-col-icon">
